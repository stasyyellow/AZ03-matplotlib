...
def parse_prices(url):
    ...
    while True:
        ...
        try: #ui-jDl24 cursor-default-hover
            next_button = driver.find_element(By.CSS_SELECTOR, 'div.Lg4gA.cursor-default-hover')  # Находим кнопку для перехода на следующую страницу
